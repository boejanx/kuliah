    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body login-card-body">
                <p class="login-box-msg">Reset Passsword</p>
                @if ($errors->any())
                ...
                <form action="{{ url('/reset-password') }}" method="post">
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating"> <input class="form-control" id="loginPassword" placeholder="" type="password" name="password_confirmation"> <label for="loginPassword">Password</label> </div>
                        <div class="input-group-text"> <span class="bi bi-lock-fill"></span> </div>
                    </div> <!--begin::Row-->
                    <div class="row">
                ...
                <div class="social-auth-links text-center mb-3 d-grid gap-2"></div> <!-- /.social-auth-links -->
